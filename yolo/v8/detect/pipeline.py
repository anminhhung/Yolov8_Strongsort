...
def run(
        source='0',
        yolo_weights='yolov8n.pt',  # model.pt path(s),
        reid_weights='osnet_x0_25_market1501.pt',  # model.pt path,
    ...
    tracker_list = []
    for i in range(bs):
        tracker = StrongSORT(model_weights=reid_weights, reID_method=reID_method, device=device, fp16=False, max_age=300)
...
def parse_opt():
    ...
    parser.add_argument('--yolo-weights', nargs='+', type=Path, default='yolov8n.pt', help='model.pt path(s)')
    parser.add_argument('--reid-weights', type=Path, default='osnet_x0_25_market1501.pt')
    parser.add_argument('--reID_method', type=str, default='default', help='default, customReID, yolo')
